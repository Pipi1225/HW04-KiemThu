...
- Vì chỉ nhờ test case do em đã tạo ở HW02, nên AI cũng không biết là phải nhập số điện thoại không bắt đầu bằng số 0 mới có thể cập nhập được tài khoản (lỗi ở đã báo cáo ở SUT EShop), nên cũng phải sửa lại ở test case `TC_FR04_11` và `TC_FR04_12`.
