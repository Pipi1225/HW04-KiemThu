...
|Lecturers&TAs|Dr.Lam Quang Vu/Dr.Tran Duy Hoang/MSc.Tran Thi Bich Hanh/<br>MSc.Truong Phuoc Loc/MSc.Ho Tuan Thanh|
...
- Maintain a public GitHub repository with a meaningful history: at least 8 commits. Only commits that change test-script files ( `.spec.js` , `.spec.ts` , or equivalent) count toward the 8-commit minimum; commits touching only - 

- the README, PDF, or other non test documents do not count. 
